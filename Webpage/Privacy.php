...
<!-- BODY -->
  <div class="content">
    ...
    <h1>Privacy Policy of Palse Tourism</h1>
    <p class="w3-border w3-padding-large w3-padding-32 w3-left" style="text-align: justify;">This page is used to inform Palse Tourism visitors regarding our policies with the collection, use and disclosure of personal information if anyone decided to use our service the Palse Tourism website. If you use our service then you agree to the collection and use of information in relation with this policy. The personal information that we collect are used in providing and improving the service. We will not use or share your information with anyone except as described in this privacy policy terms. Information Collection and Use. For a better experience while using our service we may require you to provide us with certain personally identifiable information including but not limited to your name and email address. The information that we collect will be used to contact or identify you. Log Data. We want to inform you that whenever you visit our Service, we collect information that your browser sends to us that is called Log Data. This Log Data may include information such as your computer's internet protocol or ip address, browser version, pages of our Service that you visit, the time and the date of your visit the time spent on those pages, and other statistics.</p>
    </div>

    <div style="text-align: center; padding-top: 150px">
      <img src="https://mycyberuniverse.com/images/webp/thumbnail/privacy-policy-template.webp" width="300" height="300">
    </div>
