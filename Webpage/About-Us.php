...
<!-- BODY -->
  <div class="content">
    ...
    <h1>About Us</h1>
    <p class="w3-border w3-padding-large w3-padding-32 w3-left" style="text-align: justify;">One’s a destination is never a place but a new way of seeing things. It is good people who make good place. 

    <br><br>Palse Tourism is a website that gives viewer the knowledge about certain tourist spots. It means to inform and inspire giving the people the knowledge Particularly about Cagayan de oro City. Cagayan de Oro is a city of Golden Friendship where you can look for best tourist spots you never seen before.

    <br><br>We provide information to visitors as well as locals of the city on what, where, when, and how to get around Cagayan de Oro in the best way possible, taking into consideration the time, prices, safety, transportation and culture.

    <br><br>We at Palse Tourism connect you to different sights and lodging of the city with the best customer services and cheap prices; discover events and places, as there is no better way to experience CDO with Palse Tourism leading the way.</p>
    </div>

    <div style="text-align: center; padding-top: 80px">
      <img src="images/amongus.png" width="300" height="300">
    </div>
  ...
  <div id="main"> 
    <div class="w3-top">
      <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
        ...
        <a href="About-Us.php" class="w3-bar-item w3-button w3-theme-l1">About</a>
         <a href="admin.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Admin</a>
        <a href="About-Us.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Logout</a>
      </div>
    </div>
